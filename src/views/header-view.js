...
export const HeaderView = ({state, actions}) =>
  <header>
    ...
    <p>Välj projektion på ursprungsdatan o ladda upp ett .csv, eller klistra in en tabell nedan, med två kolumner där den första är X eller N o den andra är Y eller E. Du kan ladda ned ett exempel på hur ursprungsdatan bör se ut <a download='rt90.csv' target='_blank' href='https://pap.as/sweref/rt90.csv'>här</a>. </p>
    <div class='row'>
      <div class='column'>
        <label>
